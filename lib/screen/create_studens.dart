...
class ScreenCreateStudent extends StatefulWidget {
  const ScreenCreateStudent({Key? key}) : super(key: key);

  @override
  State<ScreenCreateStudent> createState() => _CreateDataStudentState();
}

class _CreateDataStudentState extends State<ScreenCreateStudent> {
...
//  final String tuition = ModalRoute.of(context)!.settings.arguments as String;
